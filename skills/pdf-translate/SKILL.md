...
| 选择翻译引擎 | `translate start` | 从 `translate engines` API 拉取，先选普通/高级，再从所选组中选具体引擎 |
...
| 普通用户（已登录） | ✅ | ✅（限 2次/天 · 600字/次） | ✅ | 先选普通/高级；选高级会被额度校验拦截 | ✅ | 下载到本地 |
| 会员用户 | ✅ | ✅（无上述限制，消耗会员字符） | ✅ | 先选普通/高级，再选具体引擎 | ✅ | 下载到本地 |
